                    ...
                    <div class="box-body">
                        ...
                        <form action="{{ route('users.update', ['id' => $user->id]) }}" method="POST">
                            ...
                            <div class='form-group row'>
                                ...
                                <div class='col-md-7'>
                                    <input type='text' class='form-control' name='name' placeholder="User Name" required value="{{ $user->name }}">
                                </div>
                            </div>
                            <div class='form-group row'>
                            ...
                            <div class='form-group row'>
                                ...
                                <div class='col-md-7'>
                                    <input type='password' class='form-control' name='password_confirmation' placeholder="Password Confirmation" required value="{{ $user->password }}">
                                </div>
                            </div>
                            <div class="form-group row">
